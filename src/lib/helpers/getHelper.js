...
export default function () {
  ...
  function g(a) {
    return null == a
      ? String(a)
      : (a = f.exec(Object.prototype.toString.call(Object(a))))
      ? a[1].toLowerCase()
      : 'object';
  }
  function m(a, b) {
  ...
  function n(a) {
    ...
    try {
      if (
        a.constructor &&
        !m(a, 'constructor') &&
        !m(a.constructor.prototype, 'isPrototypeOf')
      )
        return !1;
    } catch (c) {
      return !1;
...
Copyright 2012 Google Inc. All rights reserved. */
  ...
  r.prototype.process = function () {
    this.registerProcessor('set', function () {
      var c = {};
      1 === arguments.length && 'object' === g(arguments[0])
        ? (c = arguments[0])
        : 2 === arguments.length &&
          'string' === g(arguments[0]) &&
          (c = p(arguments[0], arguments[1]));
      return c;
    });
    this.i = !0;
  ...
  function v(a, b, c) {
    ...
    if (a.i && (a.f.push.apply(a.f, b), !a.g))
      for (; 0 < a.f.length; ) {
        ...
        else if (n(b)) for (var t in b) q(p(t, b[t]), a.c);
        else continue;
